...
namespace StreetFoo.Client.UI
{
    ...
    /// </summary>
    public sealed partial class SearchResultsPage : StreetFoo.Client.UI.Common.LayoutAwarePage
    {
        ...
        /// </summary>
        private sealed class Filter : StreetFoo.Client.UI.Common.BindableBase
        {
