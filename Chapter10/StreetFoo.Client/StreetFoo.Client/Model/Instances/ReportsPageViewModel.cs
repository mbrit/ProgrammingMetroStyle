...
namespace StreetFoo.Client
{
    ...
    public class ReportsPageViewModel : ViewModel, IReportsPageViewModel
    {
        ...
        public ICommand CreateTestReportsCommand { get { return this.GetValue<ICommand>(); } private set { this.SetValue(value); } }
        public ICommand RefreshCommand { get { return this.GetValue<ICommand>(); } private set { this.SetValue(value); } }
        public ICommand DumpSelectionCommand { get { return this.GetValue<ICommand>(); } private set { this.SetValue(value); } }
