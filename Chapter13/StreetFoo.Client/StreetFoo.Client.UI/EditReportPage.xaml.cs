...
namespace StreetFoo.Client.UI
{
    ...
    /// </summary>
    public sealed partial class EditReportPage : StreetFoo.Client.UI.Common.LayoutAwarePage
    {
        private IEditReportPageViewModel ViewModel { get; set; }
        ...
        public EditReportPage()
        {
            ...
            // bind...
            this.ViewModel = ViewModelFactory.Current.GetHandler<IEditReportPageViewModel>(this);
